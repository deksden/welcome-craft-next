...
// Check if world selection UI should be enabled
const isTestWorldsUIEnabled = process.env.NEXT_PUBLIC_ENABLE_TEST_WORLDS_UI === 'true' || 
  typeof window !== 'undefined' && window.localStorage?.getItem('ENABLE_TEST_WORLDS_UI') === 'true'
