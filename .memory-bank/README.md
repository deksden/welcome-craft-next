...
2. **`guides/product-guide.md`** — 🎯 Что и Зачем? (продукт, UX, сценарии)
3. **`tech-context.md`** — 🛠️ Как запустить? (технологии, команды, настройка)
4. **`architecture/system-patterns.md`** — 🏗️ Как построено? (архитектурные паттерны)
5. **`dev-context.md`** — 🔄 Что сейчас? (текущий фокус, статус)
6. **`tasks.md`** — 📋 Что дальше? (активные задачи в Kanban)
7. **`buglog.md`** — 🐛 Что чинить? (активные баги в Kanban)
8. **`guides/coding-standards.md`** — ✍️ Как писать код? (стандарты разработки)
...
- **`testing-overview.md`** — Стратегия тестирования, паттерны (POM, Direct Cookie Header)
- **`ui-testing.md`** — Система data-testid, UI хелперы
- **`api-auth-setup.md`** — Решения проблем аутентификации в API тестах
