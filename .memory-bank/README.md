...
- **`vercel-environment-management.md`** — 🚀 **НОВОЕ:** Управление переменными окружения через Vercel CLI и Dashboard

### 🏗️ Architecture — Архитектура  
- **`system-patterns.md`** — **Единый источник** всех архитектурных паттернов (UC-10, UC-09, мульти-домен)

### 🧪 Testing — Тестирование
- **`testing-overview.md`** — Главный навигатор по стратегии тестирования. Описывает философию, архитектурные паттерны и содержит ссылки на детальные руководства.
- **`ui-testing.md`** — Реестр `data-testid` и описание POM-архитектуры.
- **`api-auth-setup.md`** — Решение проблем с аутентификацией в API-тестах.
- **`three-level-testing-system.md`** — Детальное описание системы "Use Cases + Worlds + AI Fixtures".
- **`worlds-manifest.md`** — Описание всех доступных тестовых "миров".
