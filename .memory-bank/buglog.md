...
**Последнее обновление:** 2025-06-18 (исправлен BUG-010: world cookies cleanup)

---

## 🧊 Backlog (Новые баги)

-   [ ] **#BUG-001: Кнопка "Новый чат" не работает при открытой панели артефакта**
    -   **Priority:** High
    -   **Type:** Bug
    ...
    -   **Acceptance Criteria:**
        ...
        -   [ ] Открытая панель артефакта не должна мешать созданию нового чата.
